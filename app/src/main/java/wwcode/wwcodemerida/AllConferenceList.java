...
public class AllConferenceList {
    ...
    private AllConferenceList(Context context) {
        ...
        Conference conferenceOne = new Conference(conferenceOneHour, conferenceEndHourOne, conferenceOneAuthor, conferenceOneName, conferenceOneDesc);
        ...
        Conference conferenceTwo = new Conference(conferenceTwoHour, conferenceEndHourTwo, conferenceTwoAuthor, conferenceTwoName, conferenceTwoDesc);
        ...
        Conference conference3 = new Conference(conference3Hour, conference3EndHour, conference3Author, conference3Name, conference3Desc);
        ...
        Conference conference4 = new Conference(conference4Hour,  conference4EndHour, conference4Author, conference4Name, conference4Desc);
        ...
        Conference conference5 = new Conference(conference5Hour, conference5EndHour, conference5Author, conference5Name, conference5Desc);
        ...
        Conference conference6 = new Conference(conference6Hour, conference6EndHour, conference6Author, conference6Name, conference6Desc);
        ...
        Conference conference7 = new Conference(conference7Hour, conference7EndHour, conference7Author, conference7Name, conference7Desc);
        ...
        Conference conference8 = new Conference(conference8Hour, conference8EndHour, conference8Author, conference8Name, conference8Desc);
        ...
        Conference conference9 = new Conference(conference9Hour, conference9EndHour, conference9Author, conference9Name, conference9Desc);
        ...
        Conference conference10 = new Conference(conference10Hour, conference10EndHour, conference10Author, conference10Name, conference10Desc);
        ...
        Conference conference11 = new Conference(conference11Hour, conference11EndHour, conference11Author, conference11Name, conference11Desc);
        ...
        Conference conference12 = new Conference(conference12Hour, conference12EndHour, conference12Author, conference12Name, conference12Desc);
